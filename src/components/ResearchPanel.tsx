...
const ResearchPanel: React.FC<ResearchPanelProps> = ({ onResultSelected }) => {
    ...
    const handleResearch = async () => {
        if (!topic.trim()) {
            alert('Por favor, ingresa un tema de investigación');
            return;
        }
    ...
    return (
        <div className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">Investigación con Exa API</h2>
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-4">
                    <input
                        ...
                        placeholder="Ej: Inteligencia Artificial, Cambio Climático, etc."
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        {worthExpanding.length > 0 ? (
                            ...
                            <p className="text-gray-500">No hay resultados en esta categoría.</p>
                        )}
                    </div>
